...
//#undef PROJECTION
	...
	const int MAX_CO2_DRV_YR = 300;  //109 // maximum number of years of CO2 at regional-scale (YUAN);
	const int MAX_ATM_DRV_YR = 300;//109 // maximum number of years of atmopsheric driving data
...
//   const int END_SC_YR = 2099;
    ...
    const int MAX_EQ_YR = 2000;  // 20000 maximum number of years for equilibrium run
	const int MAX_SP_YR = 250;    // 900 maximum number of years of spinup run;

    const int BEG_TR_YR = 1801;
